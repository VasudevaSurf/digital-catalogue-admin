  ...
  const menuItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { title: "Pending Orders", href: "/dashboard/orders?status=pending" },
        {
    ...
    },
    {
      ...
      subItems: [
        { title: "WhatsApp", href: "/dashboard/messages/whatsapp" },
        { title: "SMS", href: "/dashboard/messages/sms" },
        { title: "Templates", href: "/dashboard/messages/templates" },
      ],
    },
    {
      id: "analytics",
